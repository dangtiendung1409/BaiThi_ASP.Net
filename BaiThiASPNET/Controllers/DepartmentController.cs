...
namespace BaiThiASPNET.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public DepartmentController(HRMContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            // Tính tổng số nhân viên cho mỗi phòng ban
            foreach (var department in departments)
            {
                department.NumberOfEmployees = _context.Employee.Count(e => e.DepartmentId == department.Id);
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HRMContext.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
